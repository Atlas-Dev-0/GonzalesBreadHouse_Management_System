...
class db_function
{
    ...
    public static function db_create()
    {
        ...
        try
                ...
                $db -> exec(
                    "CREATE TABLE IF NOT EXISTS [Payee_List] (
    ...
    // Insert transaction
    public static function transaction_insert($TrDate, $TrStatus, $TrType, $TrAccount, $TrToAccount, $TrPayee, $TrCategory, $TrSubCategory, $TrAmount, $TrNotes): string | bool
    {
            $ID = 0;
            $const_dbpath = costant::database_path();
            $db = new PDO("sqlite:${const_dbpath}");
    ...
    public static function transaction_select_maxid(): int
    {
            $const_dbpath = costant::database_path();
            $db = new PDO("sqlite:${const_dbpath}");
    ...
    public static function transaction_select_all(): array
    {
            $const_dbpath = costant::database_path();
            $db = new PDO("sqlite:${const_dbpath}");
            ...
            $resultarray = array();
        if($results !== false) {$resultarray = $results->fetchall(PDO::FETCH_ASSOC);
        }
            $db = null;
            return $resultarray;
    }
    ...
    public static function transaction_select_all_order_by_date(String $s_direction = 'DESC'): array
    {
            $const_dbpath = costant::database_path();
            $db = new PDO("sqlite:${const_dbpath}");
    ...
    public static function transaction_update($TrEditedId,$TrDate,$TrStatus,$TrType,$TrAccount,$TrToAccount,$TrPayee,$TrCategory,$TrSubCategory,$TrAmount,$TrNotes)
    {
            ...
            $statement = $db-> prepare(
                "UPDATE New_Transaction SET Date = :TrDate, Status = :TrStatus, Type = :TrType,
    ...
    public static function bankaccount_select_all()
    {
        ...
        $resultarray = array();
        if($results !== false) {$resultarray = $results->fetchAll(PDO::FETCH_COLUMN, 0);
        }
        $db = null;
        return $resultarray;
    }
    ...
    public static function payee_insert_single($Payee,$Category,$SubCategory)
    {
            ...
            $statement = $db -> prepare(
                "INSERT or IGNORE INTO Payee_list (PayeeName,DefCateg,DefSubCateg)
    ...
    public static function payee_update_single($Payee,$Category,$SubCategory)
    {
            ...
            $statement = $db -> prepare(
                "UPDATE Payee_list SET DefCateg = :DefCateg, DefSubCateg = :DefSubCateg
    ...
    public static function subcategory_select_all($Category)
    {
        ...
        $statement-> execute();
        $resultarray = array();
        if($statement !== false) {$resultarray = $statement->fetchall(PDO::FETCH_ASSOC);
        }
    ...
    public static function category_insert_json(String $CategoryJSON) : void
    {
            ...
            $db = new PDO("sqlite:${const_dbpath}");
            $statement = $db -> prepare(
                'INSERT or IGNORE INTO Category_list (CategoryName,SubCategoryName)

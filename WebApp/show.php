...
function drawRecordRow(Array $a_transaction, String $s_date) : void
{
    ...
    case '': $TrStatusShow = ''; 
        break;
    case 'R': $TrStatusShow = 'ok-sign'; 
        break;
    case 'V': $TrStatusShow = 'remove-sign'; 
        break;
    case 'F': $TrStatusShow = 'question-sign'; 
        break;
    case 'D': $TrStatusShow = 'duplicate'; 
        break;
    default: $TrStatusShow = $a_transaction['Status'];
        ...
        {
        case 'Withdrawal': $TrTypeShowFormatted = 'minus'; 
            break;
        case 'Deposit': $TrTypeShowFormatted = 'plus'; 
            break;
        case 'Transfer': $TrTypeShowFormatted = 'transfer'; 
            break;
    ...
    if (costant::disable_payee() == false) {design::table_cell($TrPayeeShow, 'transaction-extra-columns');
    }
    ...
    else if (costant::disable_category() == false) {design::table_cell($TrCategoryShow, '');
    }
            ...
            // echo '<table class = "table table-hover table-condensed table-bordered">'; //TABLE BORDERED FOR DEBUG
                echo '<thead>';
                    echo '<tr>';
                        ...
                        echo '<th>Account</th>';
    if (costant::disable_payee() == false) {echo "<th class='transaction-extra-columns'>Payee</th>";
    }
    if (costant::disable_category() == false) {echo '<th>Category</th>';
    }
                    echo '</tr>';
                echo '</thead>';
